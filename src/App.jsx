...
const Onboarding = ({ t, onComplete, lang, onLangChange }) => {
  ...
  const [step, setStep] = useState(1); // 1: avatar & name, 2: guide

  const handleNext = (userName, avatar) => {
    setStep(2);
    // Store temp data for final completion
    setName(userName);
